 ...
 */
public class ContenedorPatata implements ContenedorInterface<Patata> {

    /// ArrayList con el conjunto de objetos contenidos.
    private ArrayList<Patata> objetosContenidos;

    /**
     * Constructor.
     */
    public ContenedorPatata() {
        objetosContenidos = new ArrayList<Patata>();
    }
     ...
     */
    public Patata getPorPosicion(final int posicion) throws IllegalArgumentException {
    ...
    */
    public Patata getPorId(final int id) {
        Patata objeto = null;
     ...
     */
    public ContenedorPatata add(final Patata objeto) throws IllegalArgumentException {
        if (objeto == null) {
     ...
     * @return La propia instancia de Contenedor.
     */
    public ContenedorPatata remove(final Patata objeto) throws IllegalArgumentException {
        if (objeto == null) {
